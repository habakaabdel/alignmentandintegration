/* The day's information settling into order. One persistent 2D world behind the
   AI readiness page.
...
(function () {
  ...
  var PAPER = [248, 245, 240];    /* --paper #f8f5f0 */
  var MARK = [138, 84, 32];       /* --mark #8a5420 */
  var MARK_DEEP = [94, 56, 18];   /* --mark-deep #5e3812 */
  var WARM = [165, 125, 75];
  var NOISE = [113, 125, 118];
